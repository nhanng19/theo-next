            ...
            <div className="flex w-full flex-1 flex-row gap-4">
              ...
              <div className="flex w-full flex-col">
                ...
                <div className={`mt-5 flex flex-col gap-3 ${isComment && "mb-10"}`}>
                  <div className="flex gap-3.5">
                    <Image src="/assets/heart-gray.svg" alt="heart" width={24}
                     ...
                     <Link href={`/thread/${id}`}><Image src="/assets/reply.svg" alt="heart" width={24}
                     height={24} className="cursor-pointer object-contain"/></Link>
                ...
                {isComment && comments.length > 0 && (
                  <Link href={`/thread/${id}`} className="mt-1 text-subtle-medium text-gray-1"><p>{comments.length} replies</p></Link>
                )}
            </div>
          </div>
        </article>
